...
<section class="filters-section">
    ...
    <div class="filters-box">
        <button id="filter-categories" class="filter-toggle" aria-expanded="false" data-value="">
            <span id="categorie">CATÉGORIES</span>  <span class="arrow">▼</span>
        </button>
    ...
    <!-- Filtre Formats -->
    <div class="filters-box">
        <button id="filter-formats" class="filter-toggle" aria-expanded="false" data-value="">
    ...
    <!-- Filtre Trier par -->
    <div class="filters-box">
        <button id="filter-sort" class="filter-toggle" aria-expanded="false" data-value="DESC">
