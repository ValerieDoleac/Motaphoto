...
<div class="photo-item">
    <div class="photo-image">
        <a href="<?php echo get_permalink($photo_id); ?>">
            <?php echo get_the_post_thumbnail($photo_id, 'photo-suggestion'); ?>
        </a>
    </div>
    <div class="photo-overlay">
        <div class="photo-details">
            <h3 class="photo-title"><?php echo get_the_title($photo_id); ?></h3>
        ...
        <div class="photo-icons">
            <a href="<?php echo get_permalink($photo_id); ?>" class="icon eye-icon" title="Voir les infos">👁️</a>
            <a href="<?php echo wp_get_attachment_url(get_post_thumbnail_id($photo_id)); ?>" class="icon fullscreen-icon" target="_blank" title="Plein écran">⛶</a>
        </div>
    </div>
</div>
